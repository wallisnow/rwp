...
public class CommonCheckboxListComponent extends CheckboxList{
	
	static Logger logger = Logger.getLogger(TranslateUtils.class);

	public CommonCheckboxListComponent(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
