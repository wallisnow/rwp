...
public class StringUtils implements Serializable{
	...
	// 应用内编码
	public static final String USER_DEFAULT_CHARSET = "GBK";
	 ...
	 * @throws Exception
	 */
	public static String ChangeEncoding(String changeString,
			String oldCharsetName, String newCharsetName) throws Exception {
	...
	public static String toByteBasedString(String changeString) throws Exception {
		return ChangeEncoding(changeString, USER_DEFAULT_CHARSET, SINGLE_BYTE_CHARSET);
	}
	...
	public static String fromByteBasedString(String changeString) throws Exception {
		return ChangeEncoding(changeString, SINGLE_BYTE_CHARSET, USER_DEFAULT_CHARSET);
	}
