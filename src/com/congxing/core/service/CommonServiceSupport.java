...
public class CommonServiceSupport implements Serializable {
	...
	public <T> T doQuery(String sql, ResultSetHandler<T> rsh, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<T, T>(sql, rsh, params){
	...
	public <T> T doQuery(String sql, ResultSetHandler<T> rsh, int page, int size, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<T, T>(sql, rsh, page, size, params){
			public T execute(Connection conn) throws SQLException {
				return SQLRunner.query(conn, this.getSql(), this.getRsh(), this.getPage(), this.getSize(), this.getParams());
			}
		});
	}
	
	public <T> List<T> doQueryList(String sql, Class<T> beanClass, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<List<T>, T>(sql, beanClass, params){
	...
	public <T> List<T> doQueryList(String sql, Class<T> beanClass, int page, int size, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<List<T>, T>(sql, beanClass, page, size, params){
			public List<T> execute(Connection conn) throws SQLException {
				return (List<T>) SQLRunner.queryList(conn, this.getSql(), this.getBeanClass(), this.getPage(), this.getSize(), this.getParams());
			}
		});
	}
	
	public long doStat(String sql, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<Long, Long>(sql, params){
	...
	public int doExecute(String sql, Object... params) throws SQLException {
		return DAOFactory.getInstance().getSessionFactory().getCurrentSession().doReturningWork(new AbstractReturningWork<Integer, Integer>(sql, params){
