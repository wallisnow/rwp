  ...
  <head>
	...
	function dochangePwd(){
		if(formCheck("contentForm")){
			...
			$.getJSON(ctx + "/system/user/changePwdJson.action", params, function(json){
...
<div class="formPageHeader">
	...
	<div class="formContent">
		<p>
			<label>当前密码</label>
			<s:password name="oldpassword" id="oldpassword" cssClass="required "/>
		</p>
		<p>
			<label>新密码</label>
