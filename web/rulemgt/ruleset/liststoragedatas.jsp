...
<head>
	...
	<!--
		...
		function doListReader(){
			...
			var url = addParam(ctx + "/rulemgt/storage/list.action", "rulesetPK", PKS[0]);
			window.location.href = url;
		}
		function doShowListReader(PK){
			var url = addParam(ctx + "/rulemgt/storage/list.action", "rulesetPK", PK);
			window.location.href = url;
		}
	-->
	</script>
...
<body>
<form action="${ctx}/rulemgt/ruleset/listStorageDatas.action" method="post" id="queryForm" onsubmit="return formCheck();">
...
<div class="searchPageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="config" href="Javascript:doListReader();"><span>配置存储器</span></a></li>
		</ul>
	</div>
	<div class="tableBar">
	<table class="list">
