...
function href() {
	location = ctx + "/common/batch/upload.jsp?filename="
			+ $("#saveAsFullPath").val();
}
				...
				<div id="fileArea"
					...
					<div id="uploadedInfo"
						...
						<p id="unloadedFileName">
							...
							<a href="javascript:href()"><span style="color: blue"><s:property
										value="%{paramsMap.saveAsFullPath}" /> </span> </a>
						</p>
						<p>
							<label style="width: 100px;">
								上传文件原名:
							</label>
							<strong><s:property value="fileName" /> </strong>
						</p>
					</div>
				</div>
					...
					<table>
						<tbody style="vertical-align: top;">
							<tr>
								...
								<td>
									.txt文本文件 (1.文本里不要留空行和多余的空格； 2.文件名的后缀必须是小写的".txt")
								</td>
							</tr>
							<tr>
								<td>
								...
								<td style="color: red;">
									<pre><tiles:getAsString name="format" /></pre>
								</td>
							</tr>
							<tr>
								<td>
